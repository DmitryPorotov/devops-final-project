...
class LobbyManagerService {
  ...
  public async processMessage(
    ...
    switch (message.body.type) {
      ...
      default:
        throw new Error(`Unknown chat message type '${message.body.type}'.`);
    }
