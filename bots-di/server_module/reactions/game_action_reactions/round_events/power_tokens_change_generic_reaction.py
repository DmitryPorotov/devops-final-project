from DTO.actions.action import ActionResolveConsolidatePowerOrder, ActionResolveRaidOrder
...
class PowerTokensChangeGenericReaction(BaseActionReaction):
    def __init__(self, game_state: GameState, reply: Reply[ActionCollectTaxes | ActionResolveConsolidatePowerOrder | ActionResolveRaidOrder]):
        super().__init__(game_state, reply)

    def update_game_state(self):
        pa: ActionCollectTaxes | ActionResolveConsolidatePowerOrder | ActionResolveRaidOrder = self._reply['player_action']
