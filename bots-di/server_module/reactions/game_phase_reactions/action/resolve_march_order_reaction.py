...
class ResolveMarchOrderReaction(BasePhaseReaction):
    ...
    def __choose_target_tiles(self, source: int) -> dict[int, list[MilitaryUnit]]:
        ...
        potential_targets = source_tile.neighbour_tiles if source_tile.tile_type is BoardTileType.SEA or source_tile.tile_type is BoardTileType.PORT else self.__find_reachable_targets(source_tile, [], [])
