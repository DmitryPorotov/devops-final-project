...
def download_bob():
    ...
    #     print('Found stable release version ' + stable_release_version_result)
    # else:
    ...
    ## forcing 1.9.1 because later versions break the UI
    jar_url = "defold/defold/releases/download/1.9.1/bob.jar"
